...
<sup>\* You may now run into type errors if you were passing</sup> <sup></sup><sup>`Stringable`</sup> <sup></sup><sup>objects to</sup> <sup></sup><sup>`of()`</sup> <sup></sup><sup>or any of the methods internally calling</sup> <sup></sup><sup>`of()`</sup><sup>, with</sup> <sup></sup><sup>`strict_types`</sup> <sup></sup><sup>enabled. You can fix this by casting</sup> <sup></sup><sup>`Stringable`</sup> <sup></sup><sup>objects to</sup> <sup></sup><sup>`string`</sup> <sup></sup><sup>first.</sup>
