...
3. [Estado Actual de la API](#3-estado-actual-de-la-api)
4. [Análisis Detallado por Sección del Documento](#4-análisis-detallado-por-sección-del-documento)
   - 4.1 [Encabezado del Comprobante](#41-encabezado-del-comprobante)
   - 4.2 [Detalle de Mercancía o Servicio](#42-detalle-de-mercancía-o-servicio)
   - 4.3 [Resumen del Comprobante / Totales / Moneda](#43-resumen-del-comprobante--totales--moneda)
   - 4.4 [Información de Referencia](#44-información-de-referencia)
   - 4.5 [Otros (Uso Comercial)](#45-otros-uso-comercial)
5. [Brechas Críticas — Hacienda Rechazaría el Comprobante](#5-brechas-críticas--hacienda-rechazaría-el-comprobante)
6. [Brechas de Alta Prioridad — Campos Condicionales-Obligatorios](#6-brechas-de-alta-prioridad--campos-condicionales-obligatorios)
7. [Brechas de Prioridad Media](#7-brechas-de-prioridad-media)
8. [Brechas de Baja Prioridad](#8-brechas-de-baja-prioridad)
9. [Análisis de Validaciones](#9-análisis-de-validaciones)
10. [Análisis de Estructura de Base de Datos](#10-análisis-de-estructura-de-base-de-datos)
11. [Análisis del Generador XML](#11-análisis-del-generador-xml)
12. [Tabla Consolidada de Brechas](#12-tabla-consolidada-de-brechas)
13. [Plan de Remediación Recomendado](#13-plan-de-remediación-recomendado)
14. [Apéndice A: Mapeo Completo Campo por Campo](#apéndice-a-mapeo-completo-campo-por-campo)
15. [Apéndice B: Archivos Relevantes del Proyecto](#apéndice-b-archivos-relevantes-del-proyecto)
...
| TipoCambio=1 para CRC | 🟠 | Si moneda=CRC, tipo_cambio DEBE ser 1 |
...
|:-:|---------------|------|:----:|:--:|:---:|:---:|:--:|:--:|:--:|:---:|-----------|-----------|:------:|
| 1 | Clave | String | 50 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `clave` | comprobantes_electronicos_fe | ✅ |
...
| 5 | NumeroConsecutivo | String | 20 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `consecutivo` | comprobantes_electronicos_fe | ✅ |
| 6 | FechaEmision | DateTime | — | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `fecha_emision` | comprobantes_electronicos_fe | ✅ |
...
| 21 | Receptor.Nombre | String | 100 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `receptor_nombre` | comprobantes_electronicos_fe | ✅ |
| 22 | Receptor.Identificacion.Tipo | String | 2 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `receptor_tipo_identificacion` | comprobantes_electronicos_fe | ✅ |
| 23 | Receptor.Identificacion.Numero | String | 20 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `receptor_numero_identificacion` | comprobantes_electronicos_fe | ⚠️ VARCHAR(12) |
...
| 33 | Receptor.CorreoElectronico | String | 160 | 2 | 2 | 2 | 2 | 2 | 2 | 2 | `receptor_email` | comprobantes_electronicos_fe | ⚠️ VARCHAR(100) |
| 34 | CondicionVenta | String | 2 | 1 | 1 | 1 | 1 | 1 | 1 | 1 | `condicion_venta` | comprobantes_electronicos_fe | ✅ |
| 35 | CondicionVentaOtros | String | 100 | 2 | 2 | 2 | 2 | 2 | 2 | 4 | — | — | ❌ |
| 36 | PlazoCredito | Int | 5 | 2 | 2 | 2 | 2 | 2 | 2 | 4 | `plazo_credito` | comprobantes_electronicos_fe | ✅ |
...
| Archivo | Tabla |
|---------|-------|
| `2025_02_08_create_hacienda_comprobantes_table.php` | hacienda_comprobantes |
| `2025_11_19_100146_000000_create_consecutivos_fe_table.php` | consecutivos_fe |
| `2025_11_19_100147_000000_create_comprobantes_recibidos_electronicos_table.php` | comprobantes_recibidos_electronicos |
| `2025_11_22_150000_create_mensajes_hacienda_table.php` | mensajes_hacienda |
| `2025_11_22_150100_create_tipos_comprobantes_fe_table.php` | tipos_comprobantes_fe |
| `2025_11_26_184030_create_comprobantes_electronicos_fe_table.php` | comprobantes_electronicos_fe |
| `2025_11_26_184109_create_fe_lineas_detalle_table.php` | fe_lineas_detalle |
| `2025_11_26_184143_create_fe_certificados_digitales_table.php` | fe_certificados_digitales |
| `2025_11_26_184143_create_fe_oauth_tokens_table.php` | fe_oauth_tokens |
| `2025_12_03_023558_add_v44_fields_to_fe_tables.php` | ALTER fe_lineas_detalle + comprobantes_electronicos_fe |
...
- Validación: obligatorio cuando tipo_documento='03' (FEC)
...
**Impacto:** Obligatorio en FEC cuando tipo_identificacion emisor = '05' (Extranjero No Domiciliado).
...
| Campo DB | `tipo_transaccion` en comprobantes_electronicos_fe | ✅ Existe |
...
| 11 | receptor_email max 160 | 🟢 Bajo | Receptor | ⚠️ | — | ⚠️ |
...
| 47 | receptor_numero_identificacion max 20 | 🟠 Alto | DB + Val | ⚠️ 12 | — | ⚠️ |
...
| 58 | hacienda_comprobantes clave VARCHAR(29) | 🟡 Medio | DB | ⚠️ | — | — |
...
2. receptor_email ampliar a 160
3. NombreComercial receptor
4. hacienda_comprobantes clave VARCHAR(50)
...
| 🟠 6 | `Empresa.php` | Campos nuevos (barrio, registro_fiscal) |
...
*Segundo análisis comparativo completado el 7 de abril de 2026. Total de brechas identificadas: 58 (vs 38 del primer análisis). Se recomienda priorizar las 18 brechas críticas antes de la fecha de vigencia del 01 de junio de 2025.*
