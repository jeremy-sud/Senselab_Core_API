 ...
 *
 * Valida y transforma datos de entrada para la actualización de proveedores
...
final class ProveedorUpdateDTO
{
    ...
    public static function fromRequest(Request $request): self
    {
        return new self(
            ...
            contacto_principal: $request->filled('contacto_principal') ? $request->string('contacto_principal')->trim() : null,
