...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'telefono', type: 'string', description: 'Teléfono de la sucursal', maxLength: 50, example: '+506 8868-7765', nullable: true),
        new OA\Property(property: 'email', type: 'string', format: 'email', description: 'Email de la sucursal', maxLength: 255, example: 'central@ursol.com', nullable: true),
