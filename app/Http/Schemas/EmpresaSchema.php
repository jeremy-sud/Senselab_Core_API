...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'nombre', type: 'string', description: 'Nombre de la empresa', maxLength: 255, example: 'Sistemas Ursol S.A.'),
        new OA\Property(property: 'nombre_comercial', type: 'string', description: 'Nombre comercial', maxLength: 255, example: 'Ursol', nullable: true),
        ...
        new OA\Property(property: 'telefono', type: 'string', description: 'Teléfono principal', maxLength: 50, example: '+506 8868-7765', nullable: true),
        new OA\Property(property: 'email', type: 'string', format: 'email', description: 'Email de contacto', maxLength: 255, example: 'sistemas@ursol.com', nullable: true),
