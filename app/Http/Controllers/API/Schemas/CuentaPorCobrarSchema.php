...
#[OA\Schema(
    ...
    description: 'Cuenta por cobrar de cliente',
    required: ['id', 'empresa_id', 'cliente_id', 'monto_total'],
    properties: [
        new OA\Property(property: 'id', type: 'integer', example: 1),
        new OA\Property(property: 'empresa_id', type: 'integer', example: 1),
        new OA\Property(property: 'cliente_id', type: 'integer', example: 10),
        new OA\Property(property: 'venta_id', type: 'integer', nullable: true, example: 15),
        new OA\Property(property: 'numero_documento', type: 'string', example: 'CXC-00001'),
        ...
        new OA\Property(property: 'monto_pagado', type: 'number', format: 'decimal', example: 100000.00),
        new OA\Property(property: 'monto_pendiente', type: 'number', format: 'decimal', example: 150000.00),
