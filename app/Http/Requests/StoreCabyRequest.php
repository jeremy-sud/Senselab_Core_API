...
/**
 * Request de validación para crear código CAByS
 *
 * @package App\Http\Requests
 * @author Senselab - Jeremy Arias Solano
 */
class StoreCabyRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'codigo' => ['required', 'string', 'max:20', 'unique:cabys,codigo'],
    ...
    {
        return [
            'codigo.required' => 'El código CAByS es obligatorio',
