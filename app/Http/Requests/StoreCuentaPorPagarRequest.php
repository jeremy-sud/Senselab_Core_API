...
class StoreCuentaPorPagarRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'documento_referencia_proveedor.required' => 'El número de factura del proveedor es obligatorio',
            'fecha_emision_documento.required' => 'La fecha de emisión es obligatoria',
