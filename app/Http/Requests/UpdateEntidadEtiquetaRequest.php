...
class UpdateEntidadEtiquetaRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'etiqueta_id' => 'sometimes|integer|exists:etiquetas,id',
            'entidad_tipo' => 'sometimes|string|max:50|in:clientes,productos,ventas,empleados,proveedores,facturas,cotizaciones,pedidos,ordenes_compra,proyectos',
